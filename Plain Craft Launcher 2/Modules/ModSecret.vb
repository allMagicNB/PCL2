...
#Region "更新"
    ...
    Public Sub UpdateCheckByButton()
        Hint("正在检查更新……")
        Dim LatestAction As JObject = GetJson(NetGetCodeByRequestMulty("https://api.github.com/repos/allMagicNB/PCL2/actions/runs?branch=prs&status=success&per_page=1", IsJson:=True).ToString)
